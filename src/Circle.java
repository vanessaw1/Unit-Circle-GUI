...
public class Circle
{
	public static String [] degree, radian, cos, sin, tan, sec, csc, cot;
	...
	public Circle() throws IOException {		
		...
		sec = new String [] {"1","2\u221A3/3","\u221A2", "2", "undef", "-2", "-\u221A2", "-2\u221A3/3", "-1", "-2\u221A3/3", "-\u221A2", "-2", "undef", "2", "\u221A2", "2\u221A3/3"};
		csc = new String [] {"undef", "2", "\u221A2", "2\u221A3/3", "1", "2\u221A3/3", "\u221A2", "2", "undef", "-2", "-\u221A2", "-2\u221A3/3", "-1", "-2\u221A3/3", "-\u221A2", "-2"};
		cot = new String [] {"undef", "\u221A3", "1", "\u221A3/3", "0", "-\u221A3/3", "-1", "-\u221A3", "undef", "\u221A3", "1", "\u221A3/3", "0", "-\u221A3/3", "-1", "-\u221A3"};
		//\u221A is square root, \u00B0 is degree symbol, \u03C0 is pi
	}
